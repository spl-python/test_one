            ...
            <div class="course-list">
                <div class="course-item" v-for="course in course_list" :key="course.id">
                    <div class="course-image">
                        <img :src="course.course_img" alt="" @click="push_detail(course.id)">
                    </div>
...
export default {
    ...
    methods: {
        ...
        // 点击照片跳转对应信息
        push_detail(detail_id){
            this.$router.push('/detail/'+detail_id)
        },
        // 改变分页页码
        change_page(page) {
        ...
        get_course_list() {
            ...
            this.$axios.get(this.$settings.HOST + "course/msg/", {
                params: filters
            }).then(res => {
