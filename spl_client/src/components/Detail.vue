        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{ course.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：45课时/89小时&nbsp;&nbsp;&nbsp;&nbsp;难度：初级</p>
                    <div class="sale-time">
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="chapter in chapter_list" :key="chapter.id">
                            <p class="chapter-title"><img src="/static/image/1.svg"
                                                          alt="">第{{ chapter.chapter }}章·{{ chapter.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="lesson in chapter.coursesections" :key="lesson.id">
                                    <div v-if="lesson.free_trail">
                                        <p class="name"><span class="index">{{ chapter.chapter }}-{{ lesson.id }}
                                        </span> {{ lesson.name }}<span class="free">免费</span>
                                        </p>
                                        <p class="time">{{ lesson.duration }} <img
                                            src="/static/image/chapter-player.svg"></p>
                    ...
                    <div class="tab-item" v-if="tabIndex==3">
                        ...
                        <br>
                        <el-row>
                            <el-button type="primary" @click="add_note">提交</el-button>
                        </el-row>
                        <hr>
                        <div>
                            <ul v-for="(msg,index) in notebook" :key="index">
                                <li>{{ msg }}</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="course-side">
                    <div class="teacher-info">
                        ...
                        <div class="teacher-content">
                            ...
                            <p class="narrative">签名&nbsp;:&nbsp;&nbsp;&nbsp;{{ course.teacher.signature }}
                                <br>介绍&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;{{ course.teacher.brief }}
                            </p>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            playerOptions: {
                ...
                poster: "../static/image/03.png", //视频封面图
    ...
    methods: {
        ...
        add_note() {
            if (this.textarea) {
                this.notebook.unshift(this.textarea)
            }
            this.textarea = ''
        },
    },
